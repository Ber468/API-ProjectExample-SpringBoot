...
public class TokenJwt {
	...
	private static Key gerarChave() {
		/*
		 * A string "Ber_radin" após a execução de SHA-256 e a execução do EncodeBase64 obteve
		 ...
		 */
		String keyString = "ODNhZmQ5ZTFkMDM2NWEzOTdiODBjZTIwNWViNzFmZDEzZWQ4OTNjOTgxMzc5Njg3NDYxNWI5MTU4Y2UzN2UwMg==";
	...
	public String gerarToken(String nomeUsuario, Date dataExpiracao) {
		return Jwts.builder().setHeaderParam("typ", "JWT") // definindo cabeçalho
				...
				.setIssuer("MammyLifeDataIntegra") // quem é o emissor do token
